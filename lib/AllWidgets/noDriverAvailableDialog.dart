          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text('No Vendor found', style: TextStyle(fontSize: 22.0, fontFamily: 'Brand-Bold'),),

                SizedBox(height: 25,),

                Padding(
                  padding: EdgeInsets.all(8.0),
                  child: Text('No available Vendor found in the nearby, we suggest you try again shortly', textAlign: TextAlign.center,),
                ),
